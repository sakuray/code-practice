...
public class _039_CombinationSum {
    ...
    public static void main(String[] args) {
        PrintTools.print2List(combinationSum(new int[]{2, 3, 6, 7}, 7));
        PrintTools.print2List(combinationSum(new int[]{2, 3, 5}, 8));
        PrintTools.print2List(combinationSum(new int[]{2}, 1));
        PrintTools.print2List(combinationSum(new int[]{1}, 1));
        PrintTools.print2List(combinationSum(new int[]{1}, 2));
    }
    ...
    private static void combinationSum(int[] candidates, int target, int start,
        ...
        if (target == 0) {
            ...
            for (int i = start; i < candidates.length && candidates[i] <= target; i++) {
                ...
                current.remove((Object)candidates[i]);
            }
        }
    }
